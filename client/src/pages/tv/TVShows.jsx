...
export default function TVShows() {
  ...
  useEffect(() => { if (genresLoaded) dispatch(fetchMovies({ type: "tv" })); }, [genresLoaded, dispatch]);

  const onGenreChange = (genre) => {
    if (!genre) return;
    dispatch(fetchDataByGenre({ genre, type: "tv" }));
  };
  ...
  return (
    <Container>
      ...
      <div className="data">
        <SelectGenre genres={genres} type="tv" onChange={onGenreChange} />
